...
"}"));
        ...
        labelBalance->setText(QStringLiteral("0 FLAP"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 FLAP"));
        ...
        labelImmature->setText(QStringLiteral("0 FLAP"));
        ...
        label_wallet_bg = new QLabel(OverviewPage);
        label_wallet_bg->setObjectName(QStringLiteral("label_wallet_bg"));
        label_wallet_bg->setPixmap(QPixmap(QString::fromUtf8(":/images/res/images/wallet-bg.png")));
        label_wallet_bg->setScaledContents(false);
        label_wallet_bg->setAlignment(Qt::AlignCenter);

        verticalLayout_2->addWidget(label_wallet_bg);
...
"}"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Flappycoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_wallet_bg->setText(QString());
        label_4->setText(QApplication::translate("OverviewPage", "<b>Recent transactions</b>", 0));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Flappycoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
